<script lang="ts">
	...
	const decrementLabel = $derived(language.text('Trekk fra mål', 'Trekk frå mål', 'Remove goal', 'Retirer un but'));
	const incrementLabel = $derived(language.text('Legg til mål', 'Legg til mål', 'Add goal', 'Ajouter un but'));
</script>
