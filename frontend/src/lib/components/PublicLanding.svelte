<script lang="ts">
	...
	const copy = $derived(
		language.text(
			...
			{
				targets: ['collègue', 'ami'],
				verb: 'Connectez-vous et battez votre',
				description: 'Rejoignez vos amis pour des pronostics CM, ligues, points et chat.',
				tagline: 'Pronostics Coupe du Monde avec des amis',
				lead: 'Pronostifiez chaque match, construisez votre tableau et suivez le drama de ligue au fil des points.',
				signInActions: 'Options de connexion',
				...
				diff: 'diff',
				submitTip: 'Soumettre',
				inside: 'Dans l\'application',
				showcaseTitle: 'Tout ressemble à un jour de match.',
				groupTable: 'Tableau de groupe',
				team: 'Équipe',
				pointsSystem: 'Système de points',
				maxPerMatch: 'max par match',
				correctOutcome: 'Résultat correct',
				exactScore: 'Score exact',
				totalGoals: 'Total de buts',
				goalDiff: 'Différence de buts',
				leagueChat: 'Chat de ligue',
				changedEverything: 'Ce but à la 90e minute a tout changé.',
				you: 'Vous',
				myTip: 'J\'avais 2-1. Six points !',
				chatMeta: 'Ligues privées, réactions en direct',
				ready: 'Prêt avant le coup d\'envoi',
				firstPick: 'Faites votre premier pronostic maintenant.',
				login: 'Se connecter',
